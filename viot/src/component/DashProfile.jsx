...
//firebase storage code
    ...
    uploadTask.on(
        ...
        (error)=>{
            setImageFileUploadError('could not upload image plz make file size less then 2MB'),
            setImageFile(null);
    ...
    return (
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
                <input type='file' accept='image/*' onChange={handelImageChange} ref={filePickerRef}
                hidden
                />
                ...
                {/* <Button type='submit' color='blue' outline disabled={loading || imageFileUploading} >
