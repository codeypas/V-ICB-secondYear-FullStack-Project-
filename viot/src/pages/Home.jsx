...
function Sensored() {
  return (
    <><dev>
      <img src="https://d2lk14jtvqry1q.cloudfront.net/media/0838756db55a64be73036735c642ce55_269a4a869c.jpg" alt="" />
    </dev>
      <div className="sensored_container">
        <h1 style={{fontSize:'30px',fontFamily:'sans-serif'}}className="sensored_title">BMSCE CS-IOT</h1>
      </div>
      <div className="club_images">
        <img src="https://vjit.ac.in/wp-content/uploads/2020/10/MG_0041.jpeg" alt="pic1" />
        <img src="https://iotncr.org/assets/img/portfolio/5.jpg" alt="pic2" />
      ...
      <div>
        <h1 style={{ fontSize:'30px',margin: '20px', textAlign: 'center' }}>BMSCE RESULTS</h1>
         <div className='result' style={{display: 'flex', alignItems: 'center', padding: '70px'}}>
        
        <div style={{ marginRight: '20px' }}>
          
          <img src='https://3.imimg.com/data3/BA/HI/MY-6107754/cccdc-500x500.jpg' alt='img6' style={{ width: '700px', height: 'auto', border: '3px solid black'  }} />
        </div>
        <div>
          <p style={{fontSize:'40px',marginLeft:'30px'}}>click here for results</p>
          <button style={{background:'#57b0ff',color:'white',marginLeft:'150px',height:'50px',width:'90px',borderRadius:'10px'}}><a href='https://results.bmsce.in/'>RESULTS</a></button>
        </div>
      </div>
    </div>
